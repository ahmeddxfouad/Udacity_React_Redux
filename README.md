...
- Employees can create polls with two options.
- Employees can then vote on these solutions and see which solutions have the most votes. 
- A dashboard that lists every employee ordered by the number of polls they've created and answered. To give employees incentive to use your application, HR will give a prize each quarter for the top employees who have created and answered the most polls.
...
- To Test the project you can try ```npm run test```
